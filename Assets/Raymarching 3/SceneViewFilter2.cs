...
public class SceneViewFilter2 : MonoBehaviour
{
#if UNITY_EDITOR
    ...
    static void CheckMe(SceneView sv)
    {
        ...
        SceneViewFilter2[] cameraFilters = Camera.main.GetComponents<SceneViewFilter2>();
        SceneViewFilter2[] sceneFilters = sv.camera.GetComponents<SceneViewFilter2>();
