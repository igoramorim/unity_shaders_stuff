...
// I thought it might make sense to put these together in centralized place.
// Here you will find the distance functions for basic primitives, plus the formulas for combining them together for building more complex shapes,
// as well as some distortion functions that you can use to shape your objects.
// Hopefully this will be usefull for those rendering scenes with raymarching.
// You can see some of the results you can get by using these techniques in the raymarching distance fields article.
// Lastly, this article doesn't include lighting tricks, nor marching acceleartion tricks or more advanced techniques as recursive primitives or fractals.
